    ...
    return (
        <div className="flex h-screen bg-[var(--bg-main)]">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                <header className="sticky top-0 z-30 glass border-b border-[var(--border-subtle)] h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 transition-all duration-300">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-base sm:text-lg font-semibold text-slate-800 tracking-tight flex items-center gap-2">
                            ...
                            <span className="text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full border border-blue-100">v.0.9.5.4</span>
                        </h2>
                    </div>
