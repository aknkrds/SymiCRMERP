    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Siparişler & Teklifler</h1>
                    <p className="text-slate-500 dark:text-slate-400">Sipariş takibi, teklif oluşturma ve durum yönetimi</p>
                </div>
                <button
                    onClick={handleAdd}
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <select
                                                ...
                                                className={`text-xs font-medium px-2 py-1 rounded-full border-0 cursor-pointer outline-none appearance-none ${ORDER_STATUS_MAP[order.status]?.color || 'bg-slate-100'} bg-opacity-100 dark:bg-slate-800 dark:text-slate-100`}
                                            >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    className="p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-blue-600 rounded-lg transition-colors bg-white/50 dark:bg-slate-900/60"
                                                    title="PDF İndir"
                                                >
                                                    <FileDown size={18} />
                                                </button>
                                                <button
                                                    ...
                                                    className="p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-indigo-600 rounded-lg transition-colors bg-white/50 dark:bg-slate-900/60"
                                                    title="Düzenle"
                                                >
                                                    <Eye size={18} />
                                                </button>
